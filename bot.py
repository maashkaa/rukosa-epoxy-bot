...
f"⚗ Пропорция: {ratio}\n"
            ...
            "✨ Расчет завершен.\n\n"
            "Желаю вам легкой заливки и красивой глубины.\n"
            "Пусть результат превзойдет ожидания 💎\n\n"
            "Буду рада увидеть готовую работу. 🌸\n"
            "Если захотите поделиться - отправьте фото прямо сюда.\n\n"
